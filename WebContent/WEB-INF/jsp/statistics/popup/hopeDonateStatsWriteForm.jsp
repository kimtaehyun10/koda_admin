                      ...
                      <div class="portlet-body">
                      	...
                      	<table class="table table-bordered">
                      		...
                      		<tr>                      			
                      			...
                      			<td style="text-align:left;">
									<input type="text" size="15" name="stats_regi_total" id="stats_regi_total" class="form-control input-sm" value=""/>	                                                                                                                           
                      			</td>
                      		</tr>
                      		<tr>
                      			...
                      			<td>누계</td>
                      			<td style="text-align:left;">
                      			<input type="text" size=15" name="stats_brain_donate_total" id="stats_brain_donate_total" class="form-control input-sm" value=""/>                      			
                      			</td>                      			
                      		</tr>  
                      	    <tr>                      	    	
                      			<td>사망/취소</td>
                      			<td style="text-align:left;">
                      			<input type="text" size=15" name="stats_brain_donate_cancle" id="stats_brain_donate_cancle" class="form-control input-sm" value=""/>                      			
                      			</td>
                      	    </tr>
                      	    <tr>                      	    	
                      			<td>등록</td>
                      			<td style="text-align:left;">
                      			<input type="text" size=15" name="stats_brain_donate_regi" id="stats_brain_donate_regi" class="form-control input-sm" value=""/>                      			
                      			</td>
                      	    </tr>
                      	    <tr>
                      			...
                      			<td>누계</td>
                      			<td style="text-align:left;">
                      			<input type="text" size=15" name="stats_bone_donate_total" id="stats_bone_donate_total" class="form-control input-sm" value=""/>                      			
                      			</td>                      			
                      		</tr>  
                      	    <tr>                      	    	
                      			<td>사망/취소</td>
                      			<td style="text-align:left;">
                      			<input type="text" size=15" name="stats_bone_donate_cancle" id="stats_bone_donate_cancle" class="form-control input-sm" value=""/>                      			
                      			</td>
                      	    </tr>
                      	    <tr>                      	    	
                      			<td>등록</td>
                      			<td style="text-align:left;">
                      			<input type="text" size=15" name="stats_bone_donate_regi" id="stats_bone_donate_regi" class="form-control input-sm" value=""/>                      			
                      			</td>
                      	    </tr>                		                      		
                      		<tr>
                      			<td colspan="3">
...
$("#btn").click(function(){
    	$.ajax({
            url : "/statistics/hopeDonateStatsWriteEnd.do",
            type: "POST",
            data:$("#Frm").serialize(),
            dataType:"json", 
