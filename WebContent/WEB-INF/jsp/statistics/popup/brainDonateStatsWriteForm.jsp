                      ...
                      <div class="portlet-body">
                      	...
                      	<table class="table table-bordered">
                      		<colgroup>
                       		...
                       		<tr>                      			
                      			...
                      			<td style="text-align:left;">
									<input type="text" size="20" name="stats_date" id="stats_date" class="form_datetime form-control input-sm" value="">	                                                                                                                           
                      			</td>
                      		</tr>
                      		<tr>                      			
                      			...
                      			<td style="text-align:left;">
                                    ...
                                    <div class="col-md-11">
                                       <label class="mt-checkbox" >노출                                       	                                       	
                                            <input id="stats_view" name="stats_view" type="radio" class="input-sm" value="Y" ><span></span>
                                        </label>
                                        &nbsp;&nbsp;&nbsp;
                                        <label class="mt-checkbox" >비노출                                   	                                       	
                                            <input id="stats_view" name="stats_view" type="radio" class="input-sm" value="N" ><span></span>
                                        </label> 
                                    </div>
                                </div>	                                        
                      			</td>
                      		...
                      		<tr>
                      			...
                      			<td>장기기증</td>
                      			<td style="text-align:left;">
                      			<input type="text" size=20" name="stats_sphere_tdonor1" id="stats_sphere_tdonor1" class="form-control input-sm" value=""/>                      			
                      			</td>                      			
                      		</tr>  
                      	    <tr>                      	    	
                      			<td>조직기증</td>
                      			<td style="text-align:left;">
                      			<input type="text" size=20" name="stats_sphere_edonor1" id="stats_sphere_edonor1" class="form-control input-sm" value=""/>                      			
                      			</td>
                      	    </tr>
                      	    <tr>
                      			...
                      			<td>장기기증</td>
                      			<td style="text-align:left;">
                      			<input type="text" size=20" name="stats_sphere_tdonor2" id="stats_sphere_tdonor2" class="form-control input-sm" value=""/>                      			
                      			</td>                      			
                      		</tr>  
                      	    <tr>                      	    	
                      			<td>조직기증</td>
                      			<td style="text-align:left;">
                      			<input type="text" size=20" name="stats_sphere_edonor2" id="stats_sphere_edonor2" class="form-control input-sm" value=""/>                      			
                      			</td>
                      	    </tr>
                      	    <tr>
                      			...
                      			<td>장기기증</td>
                      			<td style="text-align:left;">
                      			<input type="text" size=20" name="stats_sphere_tdonor3" id="stats_sphere_tdonor3" class="form-control input-sm" value=""/>                      			
                      			</td>                      			
                      		</tr>  
                      	    <tr>                      	    	
                      			<td>조직기증</td>
                      			<td style="text-align:left;">
                      			<input type="text" size=20" name="stats_sphere_edonor3" id="stats_sphere_edonor3" class="form-control input-sm" value=""/>                      			
                      			</td>
                      	    </tr>                  		                      		
                      		<tr>
                      			<td colspan="3">
...
$("#btn").click(function(){
    	$.ajax({
            url : "/statistics/brainDonateStatsWriteEnd.do",
            type: "POST",
            data:$("#Frm").serialize(),
            dataType:"json", 
