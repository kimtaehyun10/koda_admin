                  ...
                  <div class="portlet light portlet-fit bordered">                     
                      <div class="portlet-body">
                      	...
                      	<table class="table table-bordered">
                      		...
                      		<tr>
                      			<th>연도</th>
                      			<td style="text-align:left;" colspan="3"><input type="text" size=20" name="brd_title" id="brd_title" class="form-control input-sm" value="${selectedBoard.brd_title}"/></td>
                      			
                      			
                      			<td rowspan="2">
                      				<div class="btn-group">
                                  		<a id="fileBtn" class="btn dark btn-outline btn-circle btn-sm" href="#">수정</a>
                             		</div>
                      			</td>
                      		</tr>  
                      		<tr>                      			
