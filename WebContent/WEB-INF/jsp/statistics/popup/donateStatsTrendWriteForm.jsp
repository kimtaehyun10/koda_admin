              ...
              <div class="col-md-12">
                  ...
                  <div class="portlet light portlet-fit bordered">                     
                      <div class="portlet-body">
                      	...
                      	<input type="hidden" name="trend_idx" value="">                      	
                      		...
                      		<colgroup>
                       		...
                       		<tr>                      			
                      			...
                      			<td style="text-align:left;">
									<input type="text" size="15" name="trend_date" id="trend_date" class="form-control input-sm" value=""/>	                                                                                                                           
                      			</td>
                      		</tr>
                      		<tr>                      			
                      			<th colspan="2">뇌사 장기 기증자수</th>                     			
                      			<td style="text-align:left;">
									<input type="text" size="15" name="trend_value1" id="trend_value1" class="form-control input-sm" value=""/>	                                                                                                                           
                      			</td>
                      		</tr>
                      		<tr>                      			
                      			<th colspan="2">조직 기증자 수</th>                     			
                      			<td style="text-align:left;">
									<input type="text" size="15" name="trend_value2" id="trend_value2" class="form-control input-sm" value=""/>	                                                                                                                           
                      			</td>
                      		</tr>
                      		<tr>
                      			<td colspan="3">
...
$("#btn").click(function(){
    	$.ajax({
            url : "/statistics/donateStatsTrendWriteEnd.do",
            type: "POST",
            data:$("#Frm").serialize(),
            dataType:"json", 
