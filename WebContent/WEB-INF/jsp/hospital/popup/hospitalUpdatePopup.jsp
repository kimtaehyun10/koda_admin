              ...
              <div class="col-md-12">
                  ...
                  <div class="portlet light portlet-fit bordered">                     
                      <div class="portlet-body">
                      	...
                      	<input type="hidden" name="hospital_idx" value="${selectedHospital.hospital_idx}">
                      	<input type="hidden" name="hospital_type" value="${selectedHospital.hospital_type}">
                      	<table class="table table-bordered">
                      		...
                      		<tr>
                      			<th>병원명</th>
                      			<td style="text-align:left;" colspan="3"><input type="text" size=43" name="hospital_name" id="hospital_name" class="form-control input-sm" value="${selectedHospital.hospital_name}"/></td>
                      		</tr>  
                      		<tr>                      			
                      			<th>지역</th>
                      			<td style="text-align:left;" colspan="3">
                                    ...
                                    <div class="col-md-11">
                                       <label class="mt-checkbox" >중부권역                                       	                                       	
                                            <input id="hospital_area" name="hospital_area" type="radio" class="input-sm" value="0" ${selectedHospital.hospital_area=='0'?'checked':''}><span></span>
                                        </label>
                                        &nbsp;&nbsp;&nbsp;
                                        <label class="mt-checkbox" >충청,호남권역                                   	                                       	
                                            <input id="hospital_area" name="hospital_area" type="radio" class="input-sm" value="1" ${selectedHospital.hospital_area=='1'?'checked':''}><span></span>
                                        </label>
                                        &nbsp;&nbsp;&nbsp;
                                        <label class="mt-checkbox" >영남권역                                   	                                       	
                                            <input id="hospital_area" name="hospital_area" type="radio" class="input-sm" value="2" ${selectedHospital.hospital_area=='2'?'checked':''}><span></span>
                                        </label> 
                                    </div>
                                </div>	                                        
                      			</td>
                      		...
                      		<tr>
                      			<th>위치</th>
                      			<td style="text-align:left;" colspan="3"><input type="text" size=43" name="hospital_loc" id="hospital_loc" class="form-control input-sm" value="${selectedHospital.hospital_loc}"/></td>                      			                      	                      			
                      		</tr>
                      		<tr>
                      			<th>전화번호</th>
                      			<td style="text-align:left;" colspan="3"><input type="text" size=43" name="hospital_tel" id="hospital_tel" class="form-control input-sm" value="${selectedHospital.hospital_tel}"/></td>                      			                      	                      			
                      		</tr>
                      		<tr>
                      			<th>홈페이지</th>
                      			<td style="text-align:left;" colspan="3"><input type="text" size=43" name="hospital_link" id="hospital_link" class="form-control input-sm" value="${selectedHospital.hospital_link}"/></td>                      			                      	                      			
                      		</tr>
                      		<tr>
                      			<td colspan="2">
                      				<div class="btn-group">
...
$("#btn").click(function(){
    	$.ajax({
            url : "/hospital/hospitalUpdateEnd.do",
            type: "POST",
            data:$("#Frm").serialize(),
            dataType:"json", 
