              ...
              <div class="col-md-12">
                  ...
                  <div class="portlet light portlet-fit bordered">
                      <div class="portlet-title">
                          <div class="caption">
                              <span class="caption-subject font-dark bold uppercase">기증자 추모관</span>
                              </div>
                              <div class="actions">
                              <div class="btn-group">
                                  <a class="btn dark btn-outline btn-circle btn-sm" href="<c:url value="/remembrance/memberWriteForm.do"/>">글 등록</a>
                              </div>
                          </div>    
                      </div>
                      <div class="portlet-body">
                      	<form name="schFrm" id="schFrm" method="post" action="<c:url value="/remembrance/member.do"/>">
                      		...
                      		<tr>
                      			...
                      			<td style="text-align:left;">
                      				<select name="search_gubun" id="search_gubun" style="width:200px;">
                      					...
                      					<option value="N" ${param.search_gubun=='N'?'selected':''}>기증자명</option>                      					                      					                     					
                      				</select>
                      			</td>
                                  ...
                                  <tbody>
									<c:forEach var="memberList" items="${memberList_list}" varStatus="status">                                      
                                      <tr>
                                          ...
                                          <td style="line-height:60px; text-align: left;">${memberList.donate_title}</td>
                                          ...
                                          <a style="line-height:60px" onclick="memberUpdate(${memberList.donate_idx});"><button class="btn btn-default btn-circle mt-sweetalert" type="button"><i class="fa fa-paste"></i> 수정</button></a>
                                          <a style="line-height:60px" onclick="memberDelete(${memberList.donate_idx});"><button class="btn btn-danger btn-circle mt-sweetalert" type="button"><i class="fa fa-times"></i> 삭제</button></a>
                                          </td>
...
function memberDelete(idx) {
    if(confirm('정말 삭제하시겠습니까? ')){
    	$.ajax({
            url : "/remembrance/memberDeleteEnd.do",
            type: "POST",
            data:{
                donate_idx : idx
            },
