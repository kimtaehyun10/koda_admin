              ...
              <div class="col-md-12">
                  ...
                  <div class="portlet light portlet-fit bordered">
                      <div class="portlet-title">
                          <div class="caption">
                              <span class="caption-subject font-dark bold uppercase">하늘나라 편지</span>
                              </div>
                              <div class="actions">
                              <div class="btn-group">
                                  <a class="btn dark btn-outline btn-circle btn-sm" href="<c:url value="/remembrance/letterWriteForm.do"/>">글 등록</a>
                              </div>
                          </div>    
                      </div>
                      <div class="portlet-body">
                      	<form name="schFrm" id="schFrm" method="post" action="<c:url value="/remembrance/letter.do"/>">
                      		...
                      		<tr>
                      			...
                      			<td style="text-align:left;">
                      				<select name="search_gubun" id="search_gubun" style="width:200px;">
                      					...
                      					<option value="N" ${param.search_gubun=='N'?'selected':''}>기증자</option>                      					                      					                     					
                      					<option value="A" ${param.search_gubun=='A'?'selected':''}>권역</option>                      					                      					                     					
                      					<option value="W" ${param.search_gubun=='W'?'selected':''}>추모자</option>                      					                      					                     					
                      				</select>
                      			</td>
                                  ...
                                  <tbody>
									<c:forEach var="letterStoryList" items="${letterStoryList_list}" varStatus="status">                                      
                                      <tr>
                                          ...
                                          <td style="line-height:60px">${letterStoryList.donate_name}</td>
                                          ...
                                          <a style="line-height:60px" onclick="letterUpdate(${letterStoryList.story_idx})"><button class="btn btn-default btn-circle mt-sweetalert" type="button"><i class="fa fa-paste"></i> 수정</button></a>
...
function letterUpdate(idx){
	$("#story_idx").val(idx);
	$('#Frm').attr("action","/remembrance/letterUpdateForm.do");
	$('#Frm').submit();
}
