...
<div id="page_content" class="page-content-wrapper">
    ...
    <div class="page-content">    	
       <form role="form" name="updateForm" id="updateForm" class="form-horizontal" enctype="multipart/form-data" action="<c:url value='/remembrance/memberWriteEnd.do'/>" method="post"> 
        
        <!-- BEGIN PAGE TITLE-->
        <div class="row" style="margin-top: 70px;">
            <div class="col-md-7">            	
                <h1 class="page-title"> 기증자 추모관 글 등록</h1>                
            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                            	<div class="form-group">
                                    ...
                                    <div class="col-md-11">
                                        <input id="donate_title" name="donate_title" type="text" class="form-control input-sm" placeholder="" value="">
                                    </div>
                            	</div>                               
                                <div class="form-group">                         
                                    <label class="col-md-1 control-label">기증일</label>
                                    <div class="col-md-2">
                                        <input id="donate_date" name="donate_date" type="text" size="10" id="" class="input-sm form_datetime form-control" value="">                                        
                                    </div>
                                    <label class="col-md-1 control-label">기증자명</label>
                                    <div class="col-md-2">
                                        <input id="donate_name" name="donate_name" type="text" class="form-control input-sm" placeholder="" value="">
                                    	<label class="mt-checkbox" >익명                                       	                                       	
                                            <input id="donate_anonymity" name=donate_anonymity type="checkbox" class="input-sm" value="Y"><span></span>
                                        </label>
                                    </div>                                    
                                    <label class="col-md-1 control-label">나이</label>
                                    <div class="col-md-2">
                                        <input id="donate_age" name="donate_age" type="text" class="form-control input-sm" placeholder="" value="">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-11">
                                       <label class="mt-checkbox" >남                                       	                                       	
                                            <input id="donate_gender" name="donate_gender" type="radio" class="input-sm" value="M" ><span></span>
                                        </label>
                                        &nbsp;&nbsp;&nbsp;
                                        <label class="mt-checkbox" >여                                      	                                       	
                                            <input id="donate_gender" name="donate_gender" type="radio" class="input-sm" value="F" ><span></span>
                                        </label> 
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-11">
                                        <textarea class=" ckeditor" id="donate_contents" name="donate_contents" msg="내용을 " ></textarea>
                                    </div>
                                </div>
...
<script language="JavaScript" type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        //ckeditor
	    CKEDITOR.replace('donate_contents',{filebrowserUploadUrl:'/admin/ckeditorUpload.do',height:450});
    });
</script>