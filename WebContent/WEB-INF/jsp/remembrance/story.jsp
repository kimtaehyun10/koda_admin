              ...
              <div class="col-md-12">
                  ...
                  <div class="portlet light portlet-fit bordered">
                      <div class="portlet-title">
                          <div class="caption">
                              <span class="caption-subject font-dark bold uppercase">기증 後 스토리</span>
                              </div>
                              <div class="actions">
                              <div class="btn-group">
                                  <a class="btn dark btn-outline btn-circle btn-sm" href="<c:url value="/remembrance/storyWriteForm.do"/>">글 등록</a>
                              </div>
                          </div>    
                      </div>
                      <div class="portlet-body">
                      	<form name="schFrm" id="schFrm" method="post" action="<c:url value="/remembrance/story.do"/>">
                      		...
                      		<tr>
                      			...
                      			<td style="text-align:left;">
                      				<select name="search_gubun" id="search_gubun" style="width:200px;">
                      					...
                      					<option value="W" ${param.search_gubun=='W'?'selected':''}>코디네이터</option>                      					                      					                     					
                      				</select>
                      			</td>
                      			<th>권역</th>
                      			<td style="text-align:left;">
                      				<select name="search_janggi" id="search_janggi" style="width:200px;">
                      					<option value="">전체</option>
                      					<option value="1" ${param.search_janggi=='1'?'selected':''}>1권역</option>
                      					<option value="2" ${param.search_janggi=='2'?'selected':''}>2권역</option>
                      					<option value="3" ${param.search_janggi=='3'?'selected':''}>3권역</option>                      					                      					                    					                      					                     					                   					                      					                      					                     					
                      				</select>
                      			</td>
                      			<td rowspan="2">
                      				<div class="btn-group">
                                  ...
                                  <tbody>
									<c:forEach var="letterStoryList" items="${letterStoryList_list}" varStatus="status">                                      
                                      <tr>
                                          ...
                                          <td style="line-height:60px">${letterStoryList.story_area}권역</td>
                                          ...
                                          <a style="line-height:60px" onclick="storyUpdate(${letterStoryList.story_idx})"><button class="btn btn-default btn-circle mt-sweetalert" type="button"><i class="fa fa-paste"></i> 수정</button></a>
...
function storyUpdate(idx){
	$("#story_idx").val(idx);
	$('#Frm').attr("action","/remembrance/storyUpdateForm.do");
	$('#Frm').submit();
}
