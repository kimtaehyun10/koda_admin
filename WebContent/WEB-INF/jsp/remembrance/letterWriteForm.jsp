    ...
    <div class="page-content">    	
       <form role="form" name="updateForm" id="updateForm" class="form-horizontal" enctype="multipart/form-data" action="<c:url value='/remembrance/letterStoryWriteEnd.do'/>" method="post"> 
        ...
        <div class="row" style="margin-top: 70px;">
            <div class="col-md-7">            	
                <h1 class="page-title"> 하늘나라 편지 등록</h1>                
            </div>
		...
		<input type="hidden" name="story_gubun" value="letter">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">                         
                                    ...
                                    <div class="col-md-2">
                                        <input id="donate_name" name="donate_name" type="text" class="form-control input-sm" placeholder="" value="" readonly>
