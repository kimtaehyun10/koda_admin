              ...
              <div class="col-md-12">
                  ...
                  <div class="portlet light portlet-fit bordered">
                      <div class="portlet-title">
                          <div class="caption">
                              <span class="caption-subject font-dark bold uppercase">전체회원관리</span>
                              </div>
                              <div class="actions">
                      ...
                      <div class="portlet-body">
                      	<form name="schFrm" id="schFrm" method="post" action="<c:url value=""/>">
                      		...
                      		<tr>
                      			...
                      			<td style="text-align:left;">
                      				<select name="search_gubun" id="search_gubun" style="width:200px;">
                      					...
                      					<option value="T" ${param.search_gubun=='I'?'selected':''}>아이디</option>
                      					<option value="N" ${param.search_gubun=='N'?'selected':''}>성명</option>                      					                      					                     					
                      				</select>
                      			</td>
