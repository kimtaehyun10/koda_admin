              ...
              <div class="col-md-12">
                  ...
                  <div class="portlet light portlet-fit bordered">
                      ...
                      <div class="portlet-body">
                      	<form name="schFrm" id="schFrm" method="post" action="<c:url value="/notification/organEventPopup.p"/>">
                                  ...
                                  <tbody>
									<c:forEach var="ntcList" items="${ntcList_list}" varStatus="status">                                      
	                                      <tr>
                               				...
                               				<td>	                                      	                                        	                                       	
	                                      		<a onclick="selected('${ntcList.brd_title}',${ntcList.brd_cont_no});"><input id="checkbox" name=checkbox type="checkbox" class="input-sm"><span></span></a>	                                          
                                      	  	</td>                    	                                                                                 
...
function selected(title,no){
	opener.$("#sch_link_title").val(title);
	opener.$("#sch_link_no").val(no);
	window.close();
}
</script>