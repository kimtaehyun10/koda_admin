                  ...
                  <div class="portlet light portlet-fit bordered">                     
                      <div class="portlet-body">
                      	...
                      	<table class="table table-bordered">
                      		...
                      		<tr>
                      			<th>제목</th>
                      			<td style="text-align:left;" colspan="3"><input type="text" size="90" name="brd_title" id="brd_title" class="form-control input-sm" value="${selectedBoard.brd_title}"/></td>	
                      		</tr>  
                      		<tr>
                      			<th>작성자</th>
                      			<td style="text-align:left;" colspan="3"><input type="text" size="90" name="brd_mkr_nm" id="brd_mkr_nm" class="form-control input-sm" value="${selectedBoard.brd_mkr_nm}"/></td>	
                      		</tr>
                      		<tr>                      			
                      			<th>메인이미지</th>
                      		...
                      		<tr>
                      			<th>미리보기 URL</th>
                      			<td style="text-align:left;" colspan="3"><input type="text" size="90" name="brd_url" id="brd_url" class="form-control input-sm" value="${selectedBoard.brd_url}"/></td>	
                      		</tr>
                      		<tr>
                      			<th>다운로드 URL</th>
                      			<td style="text-align:left;" colspan="3"><input type="text" size="90" name="brd_down_url" id="brd_down_url" class="form-control input-sm" value="${selectedBoard.brd_down_url}"/></td>	
                      		</tr>
                      		<td colspan="2">
                  				<div class="btn-group">
