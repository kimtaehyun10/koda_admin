...
<div id="page_content" class="page-content-wrapper">
    ...
    <div class="page-content">    	 
        ...
        <div class="row">
            <div class="col-md-7">            	
                <h1 class="page-title"> 영상 자료실 수정</h1>                
            </div>
            ...
            <div class="col-md-12">
                <div class="portlet box blue-hoki ">
                    <div class="portlet-title">
                        <div class="caption">영상 자료실 정보</div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">                         
                                    ...
                                    <div class="col-md-5">
                                        <input id="brd_url" name="brd_url" type="text" class="form-control input-sm" placeholder="" value="${selectedBoard.brd_url}">
                                    </div>                                                                                                                                             
                                </div>
                                <div class="form-group">                         
                                    <label class="col-md-1 control-label"></label>
                                    <div class="col-md-5">
										<iframe id="youtube_video" src="${selectedBoard.brd_url}" style="width: 100%; height: 250px;" alt="동영상이없습니다."></iframe>                                                                                        
                                    </div>                                                                                                                                             
                                </div>
                                </form>
...
$("#fileBtn").click(function(){
	...
	// var brd_contents = CKEDITOR.instances['brd_contents'].getData();
    var form = $('#fileFrm')[0];
