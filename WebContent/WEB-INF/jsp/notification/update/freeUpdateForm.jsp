...
<div id="page_content" class="page-content-wrapper">
    ...
    <div class="page-content">    	
       <form role="form" name="updateForm" id="updateForm" class="form-horizontal"> 
        ...
        <div class="row">
            <div class="col-md-7">            	
                <h1 class="page-title"> 자유게시판 수정</h1>                
            </div>
            ...
            <div class="col-md-12">
                <div class="portlet box blue-hoki ">
                    <div class="portlet-title">
                        <div class="caption">자유게시판 정보</div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">                         
                                    ...
                                    <label class="col-md-1 control-label">게시글<br>패스워드</label>
                                    <div class="col-md-2">
      ...
      <form id="listForm" method="post" action="<c:url value="/notification/free.do"/>">
      ...
      <!-- 댓글등록,수정,삭제 후 자유게시판 수정 새로고침 -->
      <form id="myForm" method="post" action="<c:url value="/notification/freeUpdateForm.do"/>">
      	<input type="hidden" name="story_idx" value="${selectedLetterStory.story_idx}">
      	<input type="hidden" name="search_keyword" value="${param.search_keyword}">
      	<input type="hidden" name="search_gubun" value="${param.search_gubun}">
      	<input type="hidden" name="search_end_date" value="${param.search_end_date}">
