                      ...
                      <div class="portlet-body">
                      	...
                      	<table id="surveyTable" class="table table-bordered">
                      		<colgroup>
                       		...
                       		<tr>
                      			<th colspan="2">설문조사</th>
                      		</tr>
                      		<tr>
                      			<th>제목</th>
                      			<td>
                      				<input type="text" name="survey_title" id="survey_title" class="form-control input-sm" value=""/>
                      			</td>	
                      		</tr>  
                      		<tr>
                      			<th>작성자</th>
                      			<td>
                      				<input type="text" name="survey_writer" id="survey_writer" class="form-control input-sm" value=""/>
                      			</td>	
                      		</tr>
                      		<tr>                      			
                      			<th>시작일</th>
                      			<td>
									<input type="text" name="start_date" id="start_date" class="form-control input-sm form_datetime" value="">										                                        
                      			</td>
                      		</tr> 
                      		<tr>
                      			<th>종료일</th>
                      			<td>
                      				<input type="text" name="end_date" id="end_date" class="form-control input-sm form_datetime" value="">
                      			</td>	
                      		</tr>
                      		<tr>
                      			<th colspan="2">질문지</th>
                      		...
                      		<tr>
                      			<th>문항</th>
                      			<td>
                      				<input type="text" name="item_title" class="form-control input-sm" value=""/>
                      			</td>	
                      		</tr>
                      		<tr>
                      			<th>1</th>
                      	...
                      	<div style="text-align: center;">
                            ...
                            <a id="surveyBtn" class="btn dark btn-outline btn-circle btn-sm">질문지 추가</a>
                        </div>   
                      	</form>                   	
                      </div>                     
                  </div>                  
