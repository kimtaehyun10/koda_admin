                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">                                	
                                    ...
                                    <div class="col-md-11">
                                       	<label class="mt-checkbox"><input name="sch_skin" type="radio" class="input-sm" value="1" checked><span style="background-color: #f86786"></span></label>
                                        
                                        <label class="mt-checkbox"><input name="sch_skin" type="radio" class="input-sm" value="2"><span style="background-color: #ffb400"></span></label>
                                        
                                        <label class="mt-checkbox"><input name="sch_skin" type="radio" class="input-sm" value="3"><span style="background-color: #459609"></span></label>
                                        
                                        <label class="mt-checkbox"><input name="sch_skin" type="radio" class="input-sm" value="4"><span style="background-color: #0e9fa2"></span></label>
                                        
                                        <label class="mt-checkbox"><input name="sch_skin" type="radio" class="input-sm" value="5"><span style="background-color: #0581ff"></span></label>
                                        
                                        <label class="mt-checkbox"><input name="sch_skin" type="radio" class="input-sm" value="6"><span style="background-color: #9b6dae"></span></label>
                                        
                                        <label class="mt-checkbox"><input name="sch_skin" type="radio" class="input-sm" value="7"><span style="background-color: #333333"></span></label>
                                    </div>
                            	</div>
                            	<br>
                                <div class="form-group">                         
