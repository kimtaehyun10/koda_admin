...
<div id="page_content" class="page-content-wrapper">
    ...
    <div class="page-content">    	 
        ...
        <div class="row">
            <div class="col-md-7">            	
                <h1 class="page-title"> 생명나눔 스토리 등록</h1>                
            </div>
        ...
        <input type="hidden" name="brd_no" value="30">
            ...
            <div class="col-md-12">
                <div class="portlet box blue-hoki ">
                    <div class="portlet-title">
                        <div class="caption">생명나눔 스토리 정보</div>
                    </div>
                                ...
                                <form role="form" name="contentsUpdate" id="contentsUpdate" class="form-horizontal" enctype="multipart/form-data" action="<c:url value='/notification/contentsUpdateEnd.do'/>" method="post">
	                                <div class="form-group">
	                                    ...
	                                    <div class="col-md-11">
        									...
        									<input type="hidden" name="type" value="lifeSharing">	                                                          
