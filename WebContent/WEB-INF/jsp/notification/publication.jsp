              ...
              <div class="col-md-12">
                  ...
                  <div class="portlet light portlet-fit bordered">
                      <div class="portlet-title">
                          <div class="caption">
                              <span class="caption-subject font-dark bold uppercase">홍보물</span>
                              </div>
                              <div class="actions">
                              <div class="btn-group">
                                  <a class="btn dark btn-outline btn-circle btn-sm" href="/notification/publicationWriteForm.do">홍보물 등록</a>                                  
                              </div>
                          </div>    
                      </div>
                      <div class="portlet-body">
                      	<form name="schFrm" id="schFrm" method="post" action="<c:url value="/notification/publication.do"/>">
                                  ...
                                  <tbody>
									<c:forEach var="ntcList" items="${ntcList_list}" varStatus="status">                                      
	                                      <tr>
                                          	...
                                          	<a style="line-height:60px" onclick="publicationUpdateForm(${ntcList.brd_no},${ntcList.brd_cont_no});"><button class="btn btn-default btn-circle mt-sweetalert" type="button"><i class="fa fa-paste"></i> 수정</button></a>
                                          	<a style="line-height:60px" onclick="publicationDeleteEnd(${ntcList.brd_no},${ntcList.brd_cont_no});"><button class="btn btn-danger btn-circle mt-sweetalert" type="button"><i class="fa fa-times"></i> 삭제</button></a>
                                          	</td>
...
function publicationUpdateForm(no,cont){
	$("#brd_no").val(no);
	$("#brd_cont_no").val(cont);
	$('#Frm').attr("action","/notification/publicationUpdateForm.do");
	$('#Frm').submit();
}
function publicationDeleteEnd(no,cont) {
    if(confirm('정말 삭제하시겠습니까? ')){
    	$.ajax({
            url : "/notification/publicationDeleteEnd.do",
            type: "POST",
            data:{
                brd_no : no,
                brd_cont_no : cont
