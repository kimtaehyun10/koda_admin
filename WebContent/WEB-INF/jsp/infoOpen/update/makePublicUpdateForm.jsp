...
<div id="page_content" class="page-content-wrapper">
    ...
    <div class="page-content">    	 
        ...
        <div class="row">
            <div class="col-md-7">            	
                <h1 class="page-title"> 사전정보 공개 수정</h1>                
            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">                         
                                    ...
                                    <div class="col-md-3">
                                        <input id="brd_etc1" name="brd_etc1" type="text" size="10" id="" class="input-sm form_datetime form-control" value="${selectedBoard.brd_etc1}">                                        
                                    </div>                                                                                                          
                                </div>
                                <div class="form-group">                         
