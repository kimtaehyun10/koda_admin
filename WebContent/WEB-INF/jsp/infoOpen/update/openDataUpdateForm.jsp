...
<div id="page_content" class="page-content-wrapper">
    ...
    <div class="page-content">    	 
        ...
        <div class="row" style="margin-top: 70px;">
            <div class="col-md-7">            	
                <h1 class="page-title"> 공공데이터 개방 수정</h1>                
            </div>
            ...
            <div class="col-md-12">
                <div class="portlet box blue-hoki ">
                    <div class="portlet-title">
                        <div class="caption">공공데이터 개방 정보</div>
                    </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <form role="form" name="contentsUpdate" id="contentsUpdate" class="form-horizontal" enctype="multipart/form-data" action="<c:url value='/notification/contentsUpdateEnd.do'/>" method="post">
	                                <div class="form-group">
	                                    ...
	                                    <div class="col-md-11">
	                                    	<input type="hidden" name="brd_no" value="${selectedBoard.brd_no}">
        									<input type="hidden" name="brd_cont_no" id="brd_cont_no" value="${selectedBoard.brd_cont_no}">
        									<input type="hidden" name="type" value="openData">	                                                          
