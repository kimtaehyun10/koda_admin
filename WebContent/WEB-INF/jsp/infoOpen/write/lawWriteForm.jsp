...
<div id="page_content" class="page-content-wrapper">
    ...
    <div class="page-content">    	 
        ...
        <div class="row" style="margin-top: 70px;">
            <div class="col-md-7">            	
                <h1 class="page-title"> 법률자료실 등록</h1>                
            </div>
        ...
        <input type="hidden" name="brd_no" value="21">
            ...
            <div class="col-md-12">
                <div class="portlet box blue-hoki ">
                    <div class="portlet-title">
                        <div class="caption">법률자료실 정보</div>
                    </div>
                    <div class="portlet-body">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">                         
                                    <label class="col-md-1 control-label">첨부파일1</label>
                                    <div class="col-md-5">                                        
										<input type="file" id="brd_file_org_nm" name="brd_file_org_nm" size="34"/>
                                    </div>                                                                                                          
                                </div>
                                <div class="form-group">                         
                                    <label class="col-md-1 control-label">첨부파일2</label>
                                    <div class="col-md-5">                                        
