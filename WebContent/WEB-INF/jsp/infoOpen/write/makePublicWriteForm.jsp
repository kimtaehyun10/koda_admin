...
<div id="page_content" class="page-content-wrapper">
    ...
    <div class="page-content">    	 
        ...
        <div class="row">
            <div class="col-md-7">            	
                <h1 class="page-title"> 사전정보 공개 등록</h1>                
            </div>
        ...
        <input type="hidden" name="brd_no" value="32">
            ...
            <div class="col-md-12">
                <div class="portlet box blue-hoki ">
                    <div class="portlet-title">
                        <div class="caption">사전정보 공개 정보</div>
                    </div>
                    <div class="portlet-body">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">                         
                                    <label class="col-md-1 control-label">공개시기</label>
                                    <div class="col-md-3">
                                        <input id="brd_etc1" name="brd_etc1" type="text" size="10" id="" class="input-sm form_datetime form-control" value="">                                        
                                    </div>                                                                                                          
                                </div>
                                <div class="form-group">                         
                                    <label class="col-md-1 control-label">공개방법</label>
                                    <div class="col-md-3">
                                        <select name="brd_etc2" id="brd_etc2" class="input-sm form-control">
                                ...
                                <form role="form" name="contentsUpdate" id="contentsUpdate" class="form-horizontal" enctype="multipart/form-data" action="<c:url value='/notification/contentsUpdateEnd.do'/>" method="post">
	                                <div class="form-group">
	                                    ...
	                                    <div class="col-md-11">
        									...
        									<input type="hidden" name="type" value="makePublic">	                                                          
