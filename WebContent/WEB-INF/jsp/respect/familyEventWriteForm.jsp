...
<div id="page_content" class="page-content-wrapper">
    ...
    <div class="page-content">    	 
        ...
        <div class="row">
            <div class="col-md-7">            	
                <h1 class="page-title"> 유가족 행사 등록</h1>                
            </div>
        ...
        <input type="hidden" name="fam_evnt_idx" value="">
        <input type="hidden" name="type" value="fam_evnt_insert">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                            	<div class="form-group">
                                    ...
                                    <div class="col-md-5">
                                        <input id="fam_evnt_title" name="fam_evnt_title" type="text" class="form-control input-sm" placeholder="" value="">
                                    </div>
                            	</div>                               
                                ...
                                <form role="form" name="contentsUpdate" id="contentsUpdate" class="form-horizontal" enctype="multipart/form-data" action="<c:url value='/respect/familyEventContentsUpdateEnd.do'/>" method="post">
	                                <div class="form-group">
	                                    ...
	                                    <div class="col-md-11">
	                                    	<input type="hidden" id="fam_evnt_idx" name="fam_evnt_idx" value="">        									        										                                                          
	                                    	<textarea class="ckeditor" id="fam_evnt_contents" name="fam_evnt_contents" ></textarea>
	                                    </div>
	                                </div>
                                </form>
                            </div>
...
$.ajax({
    ...
    success: function (data) {
    	...
    	$("#fam_evnt_idx").val(reData.split(",")[1]);
