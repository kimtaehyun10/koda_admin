...
<div id="page_content" class="page-content-wrapper">
    ...
    <div class="page-content">    	 
        ...
        <div class="row">
            <div class="col-md-7">            	
                <h1 class="page-title"> 유가족 행사 수정</h1>                
            </div>
        ...
        <input type="hidden" name="fam_evnt_idx" value="${selectedFamilyEvent.fam_evnt_idx}">
        <input type="hidden" name="type" value="fam_evnt_update">
        
        <div class="row">
            <div class="col-md-12">
                <div class="portlet box blue-hoki ">
                    <div class="portlet-title">
                        <div class="caption">유가족 행사 정보</div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                            	<div class="form-group">
                                    ...
                                    <div class="col-md-5">
                                        <input id="fam_evnt_title" name="fam_evnt_title" type="text" class="form-control input-sm" placeholder="" value="${selectedFamilyEvent.fam_evnt_title}">
                                    </div>
                            	</div>                               
                                ...
                                <div class="form-group">                         
                                    ...
                                    <div class="col-md-5">
                                        ${selectedFamilyEvent.fam_evnt_file_org_name}
										<input type="file" id="fam_evnt_file_org_name" name="fam_evnt_file_org_name" size="34"/>
                                    </div>                                                                                                          
                                </div>
                                                                
                                </form>
                                <form role="form" name="contentsUpdate" id="contentsUpdate" class="form-horizontal" enctype="multipart/form-data" action="<c:url value='/respect/familyEventContentsUpdateEnd.do'/>" method="post">
	                                <div class="form-group">
	                                    <label class="col-md-1 control-label">내용</label>
	                                    <div class="col-md-11">
	                                    	<input type="hidden" name="fam_evnt_idx" value="${selectedFamilyEvent.fam_evnt_idx}">        									        										                                                          
	                                    	<textarea class="ckeditor" id="fam_evnt_contents" name="fam_evnt_contents" >${selectedFamilyEvent.fam_evnt_contents}</textarea>
	                                    </div>
	                                </div>
                                </form>
                            </div>
...
$(document).ready(function() {
    //ckeditor
    CKEDITOR.replace('fam_evnt_contents',{filebrowserUploadUrl:'/admin/ckeditorUpload.do',height:450});
...
$.ajax({
    ...
    url: "/respect/familyEventUpdateEnd.do",
    data: data,
    processData: false,
    contentType: false,
    cache: false,
