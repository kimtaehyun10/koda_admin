...
<div id="page_content" class="page-content-wrapper form-horizontal" >
    ...
    <div class="page-content">    	
        ...
        <div class="row">
            <div class="col-md-7">            	
                <h1 class="page-title"> 팝업관리 등록</h1>                
            </div>            
        </div>
        <!-- END PAGE TITLE-->
        <!-- END PAGE HEADER-->		
            ...
            <div class="col-md-12">
                <div class="portlet box blue-hoki ">
                    ...
                    <div class="portlet-body">
                        <div class="row">
                            <div class="col-md-12">
                            	<form role="form" name="writeForm" id="writeForm">                            	
                            	<input type="hidden" name="ecm_seq" value="">
                            	<input type="hidden" id="ecm_contents" name="ecm_contents" value="">
                            	<div class="form-group">
                            		<label class="col-md-1 control-label">컨텐츠명</label>
                                    <div class="col-md-11">
                                        <input id="ecm_nm" name="ecm_nm" type="text" class="form-control input-sm" placeholder="" value="">
                                    </div>
                            	</div>                               
                                <!-- <div class="form-group">                                                                                                                                   
                                    <label class="col-md-1 control-label">팝업가로크기</label>
                                    <div class="col-md-2">
                                        <input id="ecm_width" name="ecm_width" type="text" class="form-control input-sm" placeholder="" value="">
                                    </div>
                                    <label class="col-md-1 control-label">팝업세로크기</label>
                                    <div class="col-md-2">
                                        <input id="ecm_height" name="ecm_height" type="text" class="form-control input-sm" placeholder="" value="">                                    	
                                    </div>                                   
                                    <label class="col-md-1 control-label">팝업가로위치</label>
                                    <div class="col-md-2">
                                        <input id="ecm_top" name="ecm_top" type="text" class="form-control input-sm" placeholder="" value="">
                                    </div>
                                    <label class="col-md-1 control-label">팝업세로위치</label>
                                    <div class="col-md-2">
                                        <input id="ecm_left" name="ecm_left" type="text" class="form-control input-sm" placeholder="" value="">                                    	
                                    </div>
                                </div> -->
                                <div class="form-group">
                                    ...
                                    <div class="col-md-11">
                                       <label class="mt-checkbox" >사용                                       	                                       	
                                            <input id="use_yn" name="use_yn" type="radio" class="input-sm" value="Y" ><span></span>
                                        </label>
                                        &nbsp;&nbsp;&nbsp;
                                        <label class="mt-checkbox" >미사용                                   	                                       	
                                            <input id="use_yn" name="use_yn" type="radio" class="input-sm" value="N" ><span></span>
                                        </label>                                         
                                    </div>
                                </div>
                                </form>             
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-11">
                                        <textarea class=" ckeditor" id="before_ecm_contents" name="before_ecm_contents" msg="내용을 " ></textarea>
                                    </div>
                                </div>
                    ...
                    <div class="col-md-12 text-center">
                        <br>
                        <input type="button" class="btn green btn-outline btn-circle btn-sm" value="등록하기" onclick="popupWriteEnd();">
                        <br>&nbsp
                    </div>
                </div>
            </div>
