              ...
              <div class="col-md-12">
                  ...
                  <div class="portlet light portlet-fit bordered">                     
                      <div class="portlet-body">
                      	...
                      	<input type="hidden" name="banner_idx" value="${selectedBanner.banner_idx}">                      	                      	
                      	<input type="hidden" name="type" value="banner_update">                      	                      	
                      	<table class="table table-bordered">
                      		...
                      		<tr>
                      			<th>배너 타이틀</th>
                      			<td style="text-align:left;" colspan="3"><input type="text" size="90" name="banner_title" id="banner_title" class="form-control input-sm" value="${selectedBanner.banner_title}"/></td>	
                      		</tr>                        		
                      		<tr>                      			
                      			<th>배너 이미지</th>
                      			<td style="text-align:left;" colspan="3">
									<div class="form-group">                                  
                                     	${selectedBanner.banner_org_img}
                      		...
                      		<tr>
                      			<th>배너 URL</th>
                      			<td style="text-align:left;" colspan="3"><input type="text" size="90" name="banner_url" id="banner_url" class="form-control input-sm" value="${selectedBanner.banner_url}"/></td>	
                      		</tr>
                      		<td colspan="2">
                  				<div class="btn-group">
