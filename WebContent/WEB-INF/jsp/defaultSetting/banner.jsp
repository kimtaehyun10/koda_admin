              ...
              <div class="col-md-12">
                  ...
                  <div class="portlet light portlet-fit bordered">
                      <div class="portlet-title">
                          <div class="caption">
                              <span class="caption-subject font-dark bold uppercase">배너관리</span>
                              </div>
                              <div class="actions">
                              <div class="btn-group">
                                  <a class="btn dark btn-outline btn-circle btn-sm" onclick="bannerWriteForm();">배너관리 등록</a>                                  
                              </div>
                          </div>    
                      </div>
                      <div class="portlet-body">
                      	<form name="schFrm" id="schFrm" method="post" action="<c:url value="/defaultSetting/banner.do"/>">
                      ...
                      <div class="portlet-body">
                          <div class="table-scrollable">
                              <table class="table table-hover">
                                  ...
                                  <tbody>
									<c:forEach var="bannerList" items="${bannerList_list}" varStatus="status">                                      
                                      <tr>
                                          ...
                                          <td style="line-height:60px">
                                          <a style="line-height:60px" onclick="bannerUpdateForm(${bannerList.banner_idx});"><button class="btn btn-default btn-circle mt-sweetalert" type="button"><i class="fa fa-paste"></i> 수정</button></a>
                                          <a style="line-height:60px" onclick="bannerDeleteEnd(${bannerList.banner_idx})"><button class="btn btn-danger btn-circle mt-sweetalert" type="button"><i class="fa fa-times"></i> 삭제</button></a>
                                          </td>
...
function bannerWriteForm(idx){
    ...
    var posL=( screenW-popW ) / 2;    
    var posT=( screenH-popH ) / 2;
    var url = "/defaultSetting/bannerWriteForm.p";
