            ...
            <div class="col-md-12">
                <div class="portlet box blue-hoki ">
                    ...
                    <div class="portlet-body">
                    	<form name="fileFrm" id="fileFrm" role="form" class="form-horizontal" enctype="multipart/form-data" action="<c:url value='/mailbox/letterSkinUpdate.do'/>" method="post">
                    	<input type="hidden" id="letter_skin_id" name="letter_skin_id" value="${letterSkin.letter_skin_id }" />
                        <div class="row">
                            <div class="col-md-12">
	                    	...
	                    	<div class="col-md-12 text-center">
	                        	...
	                        	<input type="button" class="btn green" value="목록" onclick="javascript:fnList();" />
	                    	</div>
	                    </div>
	                    </form>
	                </div>
...
function fnSubmit() {
	...
	$.ajax({
        ...
        type: "POST",
        data: {letter_skin_id : '${letterSkin.letter_skin_id }', letter_skin_name : $('#letter_skin_name').val().trim()},
        dataType:"json", 
