            ...
            <div class="col-md-12">
                <div class="portlet box blue-hoki ">
                    ...
                    <div class="portlet-body">
                    	<form name="fileFrm" id="fileFrm" class="form-horizontal" method="post" enctype="multipart/form-data" action="<c:url value='/mailbox/letterWaitUpdate.do'/>">
                                    ...
                                    <div class="col-md-8">
                                    	<c:forEach var="letterFile" items="${letterFileList }">
                                    		<c:if test="${letterFile.letter_file_seq eq '1' }">
                                    			...
                                    			<input type="checkbox" name="delFile1" id="delFile1"/> 파일 삭제 (
                                    			<a href="javascript:fnFiledown('letter', '${letterFile.letter_id}', '${letterFile.letter_file_seq }')">${letterFile.letter_file_org_nm }</a>) ※ 파일을 삭제하지 않으셨더라도 파일을 추가하신다면 자동으로 삭제됩니다.
                                    		</c:if>
                                    	</c:forEach>
									</div>                          
                                </div>
                                    ...
                                    <div class="col-md-8">
										<c:forEach var="letterFile" items="${letterFileList }">
                                    		<c:if test="${letterFile.letter_file_seq eq '2' }">
                                    			...
                                    			<input type="checkbox" name="delFile2" id="delFile2"/> 파일 삭제 (
                                    			<a href="javascript:fnFiledown('letter', '${letterFile.letter_id}', '${letterFile.letter_file_seq }')">${letterFile.letter_file_org_nm }</a>) ※ 파일을 삭제하지 않으셨더라도 파일을 추가하신다면 자동으로 삭제됩니다.
                                    		</c:if>
                                    	</c:forEach>
									</div>                                                                                                          
                                    ...
                                    <div class="col-md-8">
										<c:forEach var="letterFile" items="${letterFileList }">
                                    		<c:if test="${letterFile.letter_file_seq eq '3' }">
                                    			...
                                    			<input type="checkbox" name="delFile3" id="delFile3 "/> 파일 삭제 (
                                    			<a href="javascript:fnFiledown('letter', '${letterFile.letter_id}', '${letterFile.letter_file_seq }')">${letterFile.letter_file_org_nm }</a>) ※ 파일을 삭제하지 않으셨더라도 파일을 추가하신다면 자동으로 삭제됩니다.
                                    		</c:if>
                                    	</c:forEach>
									</div>                                                                                                          
