        	...
        	<div class="col-md-12">
				...
				<div class="portlet-body">
                	<form name="schFrm" id="schFrm" method="post" action="<c:url value="/mailbox/letterWaitList.do"/>">
                		...
                		<input type="hidden" name="status" id="status" value="notApproval"/>
...
function fnLetterWriteForm(){
	location.href="<c:url value='/mailbox/letterNotApprovalWriteForm.do'/>";
}

function fnLetterViewForm(letter_id) {
	$("#letter_id").val(letter_id);
	$('#Frm').attr("action","/mailbox/letterNotApprovalView.do");
	$('#Frm').submit();
}

function fnLetterUpdateForm(letter_id) {
	$("#letter_id").val(letter_id);
	$('#Frm').attr("action","/mailbox/letterNotApprovalUpdateForm.do");
	$('#Frm').submit();
}
