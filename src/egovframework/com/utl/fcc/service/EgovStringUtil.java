...
public class EgovStringUtil {
    ...
    public static String unscript(String data) {
        ...
        ret = ret.replaceAll("\"", "&#34;");
        ret = ret.replaceAll("\'", "&#39;");
        ret = ret.replaceAll("%00", "null");
        ret = ret.replaceAll("%", "&#37;");
        ret = ret.replaceAll("script", "scripX");
        
        return ret;
    }
    
	/**
     * br 태그에 닫는 태그가 없는경우 변환하여 return
     * 
     * @param object
     *            원본 객체
     * @return resultVal 문자열
     */
    public static String chgBrTag(String str) {
        String retStr = "";

        if (str != null) {
            retStr = str.replaceAll("<BR>", "<br/>");
            retStr = str.replaceAll("<Br>", "<br/>");
            retStr = str.replaceAll("<bR>", "<br/>");
            retStr = str.replaceAll("<br>", "<br/>");
        }
    ...
    public static String getCheckBoxValue(String val, String trueVal, String falseVal)
    {
      String rtnVal = "";
      if ((val != null) && ((val.equals("on")) || (val.equals(trueVal))))
        rtnVal = trueVal;
      else {
        rtnVal = falseVal;
      }
