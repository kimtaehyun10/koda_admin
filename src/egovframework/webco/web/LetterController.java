...
public class LetterController {
	...
	@Resource(name = "letterService") private LetterService letterService;
	...
	@RequestMapping("/mailbox/ajaxSendSms.do")
 	public @ResponseBody JSONObject ajaxSendSms(@RequestParam Map<String, Object> commandMap, HttpServletRequest request, HttpServletResponse response) throws Exception{
		...
		if(EgovStringUtil.isEmpty(EgovStringUtil.isNullToString(commandMap.get("sms_receiver_phone_no")))) {
			...
			smsMap.put("rphone", EgovStringUtil.isNullToString(commandMap.get("sms_receiver_phone_no")));
		}
	...
	/**
 	...
 	public @ResponseBody JSONObject ajaxUseSkinLetterId(ModelMap model, @RequestParam Map<String, Object> commandMap) throws Exception{
 		Map<String, Object> rtnMap = new HashMap<String, Object>();
 	...
 	public @ResponseBody JSONObject ajaxDuplicateSkinName(ModelMap model, @RequestParam Map<String, Object> commandMap) throws Exception{
 		Map<String, Object> rtnMap = new HashMap<String, Object>();
 	...
 	public @ResponseBody JSONObject ajaxLetterReplyCheck(ModelMap model, @RequestParam Map<String, Object> commandMap) throws Exception{
 		Map<String, Object> rtnMap = new HashMap<String, Object>();
	...
	public @ResponseBody JSONObject exportExcelLetterList(ModelMap model
	...
	/**
  	...
  	public String letterSenderSearchPopup(ModelMap model, @RequestParam Map<String, Object> commandMap) throws Exception{
  		int limit = 10;    	
		int page = 1;
  	...
  	public String letterAdminSearchPopup(ModelMap model, @RequestParam Map<String, Object> commandMap) throws Exception{
  		int limit = 10;    	
		int page = 1;
  	...
  	public @ResponseBody JSONObject letterPreview(ModelMap model, @RequestParam Map<String, Object> commandMap) throws Exception {
	 ...
	 */
  	...
  	public String letterSave(ModelMap model
  			               ,@RequestParam Map<String, Object> commandMap
  	...
  	public String letterUpdate(ModelMap model
  			                  ,@RequestParam Map<String, Object> commandMap
  			                  ,@RequestParam(value="letter_file_org_nm1", required=false) MultipartFile multipartFile1
  			                  ,@RequestParam(value="letter_file_org_nm2", required=false) MultipartFile multipartFile2
  			                  ,@RequestParam(value="letter_file_org_nm3", required=false) MultipartFile multipartFile3
  	...
  	public String letterDelete(ModelMap model
  			                 ,@RequestParam Map<String, Object> commandMap
  			                 ,HttpServletRequest request) throws Exception {
  		commandMap.put("create_id", SessionUtil.getAdminId());
  	...
  	public String letterReplySave(ModelMap model
  			                     ,@RequestParam Map<String, Object> commandMap
  			                     ,@RequestParam(value="letter_file_org_nm1", required=false) MultipartFile multipartFile1
  			                     ,@RequestParam(value="letter_file_org_nm2", required=false) MultipartFile multipartFile2
  			                     ,@RequestParam(value="letter_file_org_nm3", required=false) MultipartFile multipartFile3
  ...
  //------------------------------ 발신대기함 ----------------------------------------------------------------------------------//
	 ...
	 */
  	...
  	public String letterWaitSave(ModelMap model
  			               ,@RequestParam Map<String, Object> commandMap
  			               ,@RequestParam(value="letter_file_org_nm1", required=false) MultipartFile multipartFile1
  			               ,@RequestParam(value="letter_file_org_nm2", required=false) MultipartFile multipartFile2
  			               ,@RequestParam(value="letter_file_org_nm3", required=false) MultipartFile multipartFile3
  	...
  	public String letterWaitUpdate(ModelMap model
  			                  ,@RequestParam Map<String, Object> commandMap
  			                  ,@RequestParam(value="letter_file_org_nm1", required=false) MultipartFile multipartFile1
  			                  ,@RequestParam(value="letter_file_org_nm2", required=false) MultipartFile multipartFile2
  			                  ,@RequestParam(value="letter_file_org_nm3", required=false) MultipartFile multipartFile3
  	...
  	public String letterWaitDelete(ModelMap model
  			                 ,@RequestParam Map<String, Object> commandMap
  			                 ,HttpServletRequest request) throws Exception {
  		commandMap.put("create_id", SessionUtil.getAdminId());
  		letterService.letterDelete(commandMap);
  	...
  	public String letterWaitReplyWriteForm(ModelMap model, @RequestParam Map<String, Object> commandMap) throws Exception {
  		Map<String, Object> letter = letterService.selectLetterView(commandMap);
  		List<Map<String, Object>> letterSkinList = letterService.selectLetterSkinList(commandMap);
  		model.addAttribute("letter", letter);
  		model.addAttribute("letterSkinList", letterSkinList);
  	...
  	public String letterWaitReplySave(ModelMap model
  			                     ,@RequestParam Map<String, Object> commandMap
  			                     ,@RequestParam(value="letter_file_org_nm1", required=false) MultipartFile multipartFile1
  			                     ,@RequestParam(value="letter_file_org_nm2", required=false) MultipartFile multipartFile2
  			                     ,@RequestParam(value="letter_file_org_nm3", required=false) MultipartFile multipartFile3
	 ...
	 */
  	...
  	public String letterNotApprovalWriteForm(ModelMap model, @RequestParam Map<String, Object> commandMap) throws Exception {
  		List<Map<String, Object>> letterSkinList = letterService.selectLetterSkinList(commandMap);
  		model.addAttribute("letterSkinList", letterSkinList);
  	...
  	public String letterNotApprovalSave(ModelMap model
  			               ,@RequestParam Map<String, Object> commandMap
  			               ,@RequestParam(value="letter_file_org_nm1", required=false) MultipartFile multipartFile1
  			               ,@RequestParam(value="letter_file_org_nm2", required=false) MultipartFile multipartFile2
  			               ,@RequestParam(value="letter_file_org_nm3", required=false) MultipartFile multipartFile3
  	...
  	public String letterNotApprovalUpdateForm(ModelMap model, @RequestParam Map<String, Object> commandMap) throws Exception {
  		Map<String, Object> letter = letterService.selectLetterView(commandMap);
  		List<Map<String, Object>> letterFileList = letterService.selectLetterFileList(commandMap);
  		List<Map<String, Object>> letterSkinList = letterService.selectLetterSkinList(commandMap);
  		model.addAttribute("letter", letter);
  	...
  	public String letterNotApprovalUpdate(ModelMap model
  			                  ,@RequestParam Map<String, Object> commandMap
  			                  ,@RequestParam(value="letter_file_org_nm1", required=false) MultipartFile multipartFile1
  			                  ,@RequestParam(value="letter_file_org_nm2", required=false) MultipartFile multipartFile2
  			                  ,@RequestParam(value="letter_file_org_nm3", required=false) MultipartFile multipartFile3
  	...
  	public String letterNotApprovalDelete(ModelMap model
  			                 ,@RequestParam Map<String, Object> commandMap
  			                 ,HttpServletRequest request) throws Exception {
  		commandMap.put("create_id", SessionUtil.getAdminId());
  		letterService.letterDelete(commandMap);
  	...
  	public String letterNotApprovalReplyWriteForm(ModelMap model, @RequestParam Map<String, Object> commandMap) throws Exception {
  		Map<String, Object> letter = letterService.selectLetterView(commandMap);
  		List<Map<String, Object>> letterSkinList = letterService.selectLetterSkinList(commandMap);
  		model.addAttribute("letter", letter);
  		model.addAttribute("letterSkinList", letterSkinList);
  	...
  	public String letterNotApprovalReplySave(ModelMap model
  			                     ,@RequestParam Map<String, Object> commandMap
  			                     ,@RequestParam(value="letter_file_org_nm1", required=false) MultipartFile multipartFile1
  			                     ,@RequestParam(value="letter_file_org_nm2", required=false) MultipartFile multipartFile2
  			                     ,@RequestParam(value="letter_file_org_nm3", required=false) MultipartFile multipartFile3
  	...
  	public String letterAdminSave(ModelMap model
  			                     ,@RequestParam Map<String, Object> commandMap
  			                     ,HttpServletRequest request) throws Exception {
  		commandMap.put("create_id", SessionUtil.getAdminId());
  	...
  	public String letterAdminUpdate(ModelMap model
  			                     ,@RequestParam Map<String, Object> commandMap
  			                     ,HttpServletRequest request) throws Exception {
  		commandMap.put("create_id", SessionUtil.getAdminId());
  	...
  	public String letterAdminDelete(ModelMap model
  			                     ,@RequestParam Map<String, Object> commandMap
  			                     ,HttpServletRequest request) throws Exception {
  		commandMap.put("create_id", SessionUtil.getAdminId());
	 ...
	 */
  	...
  	public String letterSkinSave(ModelMap model
  			                    ,@RequestParam Map<String, Object> commandMap
  	...
  	public String letterSkinUpdate(ModelMap model
						          ,@RequestParam Map<String, Object> commandMap
						          ,@RequestParam(value="letter_skin_file_org_nm", required=false) MultipartFile multipartFile
						          ,HttpServletRequest request) throws Exception {
  		commandMap.put("create_id", SessionUtil.getAdminId());
  	...
  	public String letterSkinDelete(ModelMap model
  			                      ,@RequestParam Map<String, Object> commandMap
  			                      ,HttpServletResponse response) throws Exception {
